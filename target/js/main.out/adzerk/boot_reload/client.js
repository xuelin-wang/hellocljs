...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11251,opts){
...
var files = cljs.core.get.call(null,map__11252__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8605__auto___11260 = arguments.length;
var i__8606__auto___11261 = (0);
while(true){
if((i__8606__auto___11261 < len__8605__auto___11260)){
args__8612__auto__.push((arguments[i__8606__auto___11261]));

var G__11262 = (i__8606__auto___11261 + (1));
i__8606__auto___11261 = G__11262;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11256){
var vec__11257 = p__11256;
var opts = cljs.core.nth.call(null,vec__11257,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11257,opts){
return (function (evt){
...
});})(conn,vec__11257,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11257,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11257,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11257,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11254){
var G__11255 = cljs.core.first.call(null,seq11254);
var seq11254__$1 = cljs.core.next.call(null,seq11254);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11255,seq11254__$1);
});

...
var attr = cljs.core.nth.call(null,vec__10976,(0),null);
...
var args10979 = [];
var len__8605__auto___10982 = arguments.length;
var i__8606__auto___10983 = (0);
while(true){
if((i__8606__auto___10983 < len__8605__auto___10982)){
args10979.push((arguments[i__8606__auto___10983]));

var G__10984 = (i__8606__auto___10983 + (1));
i__8606__auto___10983 = G__10984;
continue;
} else {
}
break;
...
var len__8605__auto___10987 = arguments.length;
var i__8606__auto___10988 = (0);
while(true){
if((i__8606__auto___10988 < len__8605__auto___10987)){
args__8612__auto__.push((arguments[i__8606__auto___10988]));

var G__10989 = (i__8606__auto___10988 + (1));
i__8606__auto___10988 = G__10989;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq10986){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10986));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__10990){
var map__10994 = p__10990;
var map__10994__$1 = ((((!((map__10994 == null)))?((((map__10994.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10994.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10994):map__10994);
var data = map__10994__$1;
var message = cljs.core.get.call(null,map__10994__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__10994__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10994__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__10996 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__10996,goog.events.EventType.CLICK,((function (G__10996,map__10994,map__10994__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__10996,map__10994,map__10994__$1,data,message,line,file))
);

return G__10996;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__10997){
var map__11001 = p__10997;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__11004){
var map__11008 = p__11004;
...
var messages = map__11008__$1;
var warnings = cljs.core.get.call(null,map__11008__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11008__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__11010 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__11010,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__11010,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__11011){
...
var messages = map__11014__$1;
var warnings = cljs.core.get.call(null,map__11014__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11014__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__11014,map__11014__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__11014,map__11014__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__11014,map__11014__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__11014,map__11014__$1,messages,warnings,exception))
;
...
}catch (e11017){if((e11017 instanceof Error)){
var __11018 = e11017;
} else {
throw e11017;
